...
######
# It should be noted that "`keras` and `tf.keras` are distinct libraries" and the first should be
# avoiding, especially for realizing batch normalization on GAN.
# Reference: robieta commented on May 29, https://github.com/tensorflow/tensorflow/issues/28580
