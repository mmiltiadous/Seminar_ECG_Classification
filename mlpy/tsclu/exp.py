"""
    Clustering raw time sereis data.
"""
import numpy as np
import pandas as pd
import os
...
if __name__ == '__main__':
    ...
    log_dir = makedirs(os.path.join(TAG_CACHE, tag))
