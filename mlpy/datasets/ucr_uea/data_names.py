""" Dataset constant, timestamp=2015 """
...
# datasets used in Multi-Scale paper.
DATASETS_44 = [
    '50words', 'Adiac', 'Beef', 'CBF', 'ChlorineConcentration', 'CinC_ECG_torso',
...
################ Category datasets set, refer to UCR official website: http://timeseriesclassification.com/dataset.php?train=%3C100&test=&leng=&class=&type=
# Category datasets by train size
