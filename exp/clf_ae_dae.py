...
from tcgan.model.ae.dae_tcgan import DAETCGANConfig, DAETCGAN
...
if __name__ == '__main__':
    tag = 'exp_ae_dae' # the pre-trained model
    ...
    exp = ExperimentClf(tag, DAETCGAN, DAETCGANConfig, DIR_DATA_UCR15, data_name_list, log_dir,
